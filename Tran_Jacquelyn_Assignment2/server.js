//credit for code from Eric Choy  <-- this is not good enough. Did you copy all the code from him? Why are you copying code from him?
...
const { request } = require('http'); // I don't think this is needed
var fs = require('fs');
